...
include_once 'components/landing.php';
include_once 'components/features.php';
include_once 'components/categories.php';
include_once 'components/bestSelling.php';
include_once 'components/complements.php';
include_once 'components/relatedProducts.php';
